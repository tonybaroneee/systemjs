...
function register(loader) {
  ...
  function registerModule(name, deps, declare) {
    ...
    if (typeof declare == 'boolean')
      return registerDynamicModule.apply(this, arguments);
  ...
  function registerDynamicModule(name, deps, declare, execute) {
    if (typeof name != 'string') {
      execute = declare;
      declare = deps;
      deps = name;
  ...
  function defineRegister(loader) {
    ...
    loader.registerDynamic = registerDynamicModule;
